...
class ShowDialog extends StatelessWidget {
  ...
  const ShowDialog({Key? key, required this.httpService, required this.post})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      ...
      builder:
          (BuildContext context, AsyncSnapshot<List<GroupPopupData>> snapshot) {
        if (snapshot.hasData) {
          List<GroupPopupData> posts = snapshot.data!;
          return AlertDialog(
